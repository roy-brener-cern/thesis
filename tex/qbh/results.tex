...
\begin{figure}
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/SR/el/background_pie.pdf}
    }
    %\hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/SR/mu/background_pie.pdf}
    }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/SR/el/mLepJetSR_logBins_pad1.pdf}
  }
  \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/SR/mu/mLepJetSR_logBins_pad1.pdf}
  }
...
\begin{figure}[h]
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_el_ADDn6.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_mu_ADDn6.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_el_RSn1.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_mu_RSn1.pdf}
    }
...
\begin{figure}[h]
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_el_ADDn4.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_mu_ADDn4.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_el_ADDn2.pdf}
    }
    \hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/limits/theory_plus_limits_with_brazil_mu_ADDn2.pdf}
    }
