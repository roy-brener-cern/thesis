...
\input{tables/qbh/lep_exp_systs.tex}
\input{tables/qbh/jet_exp_systs.tex}
...
The signal region used for both channels is defined in Chapter REFERENCE and uses cuts only on the properties of the jet and respective lepton. Therefore only systematics on these objects are presented, for the total backgrounds. 
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/SR_ExpGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/SR_ExpGrouped.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/SR_El.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/SR_Mu.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/SR_Jet.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/SR_Jet.pdf}
  }
...
The cuts used for the $W$+jets CR and VR, defined in Chapter REFERENCE , are on the properties of the jet, respective lepton and the MET significance. The systematics on these objects are considered, for the total background. 
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/WCRVR_ExpGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/WCRVR_ExpGrouped.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/WCRVR_El.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/WCRVR_Mu.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/WCRVR_Jet.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/WCRVR_Jet.pdf}
  }
...
\subsubsection*{$Z$+Jets Control and Validation Regions}
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/ZCRVR_ExpGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/ZCRVR_ExpGrouped.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/ZCRVR_El.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/ZCRVR_Mu.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/ZCRVR_Jet.pdf}
  }
  % \hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/ZCRVR_Jet.pdf}
  }
...
The signal region used for both channels is defined in Chapter REFERENCE. FIG.~\ref{fig:SR_TH_syst} shows the contributions to the theoretical systematic uncertainties of the total background  in the signal region. For both channels the leading contribution is from Sherpa QCD scales, and sub leading from other sherpa uncertainties, $\alpha_s$ and PDF. 

\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/SR_ThGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/SR_ThGrouped.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/WCRVR_ThGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/WCRVR_ThGrouped.pdf}
  }
...
\begin{figure}[h]
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/ej/ZCRVR_ThGrouped.pdf}
  }
  %\hfill
  \subfloat{
    \includegraphics[width=0.5\textwidth]{figures/qbh/SystTool/muj/ZCRVR_ThGrouped.pdf}
  }
...
\begin{figure}
    \subfloat{
      \includegraphics[width=0.34\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_el_RSn1_Mth6.0/Pulls/All/NuisPar.pdf}
    }
    \hspace{2.5cm}
    \subfloat{
      \includegraphics[width=0.33\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_mu_RSn1_Mth6.0/Pulls/All/NuisPar.pdf}
    }
...
\begin{figure}
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_el_RSn1_Mth6.0/CorrMatrix.pdf}
    }
    %\hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_mu_RSn1_Mth6.0/CorrMatrix.pdf}
    }
...
\subsection{Nuisance parameter impacts}

The impact of nuisance parameters associated with the systematic uncertainties described hitherto is evaluated and ranked. A post-fit error of $\pm 1$ standard deviation is placed on each nuisance parameter, $\theta_{i}\in \boldsymbol{\theta}$. The likelihood function described in Chapter REFERENCE, $\mathcal{L}(\mu, \boldsymbol{\theta})$ ($\mu$ is the signal strength in this very specific context, not to be confused with $\mu$ for nuisance parameter impact) is profiled with this fixed nuisance parameter to assess its impact on the Parameter of Interest (PoI), which is the signal strength, $\mu$, in this analysis. Taking all nuisance parameters to have a Gaussian PDF, the values of $\Delta\mu/\mu$ thus obtained constitute the correlation coefficients between the PoI and the nuisance parameter.
...
\begin{figure}
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_el_RSn1_Mth6.0/RankingSysts_SigXsecOverSM_systs.pdf}
    }
    %\hfill
    \subfloat{
      \includegraphics[width=0.5\textwidth]{figures/qbh/TRExFitter_Outputs/QBH_mu_RSn1_Mth6.0/RankingSysts_SigXsecOverSM_systs.pdf}
    }
