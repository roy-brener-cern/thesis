...
\subsection{Real rate calculation}
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/PR/h_PR_pt_ele.pdf}
    }
    %\hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/PR/h_PR_eta_ele.pdf}
    }
...
\begin{figure}    
    \centering
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/PR/PR_pT_eta_ele.pdf}
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_ele_medium_jet130.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/eta_ele_medium_jet130.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_ele_tight_jet130.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/eta_ele_tight_jet130.pdf}
    }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_medium_jetpt130_eta0p00_0p70.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_medium_jetpt130_eta0p70_1p37.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_tight_jetpt130_eta0p00_0p70.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_tight_jetpt130_eta0p70_1p37.pdf}
    }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_medium_jetpt130_eta1p52_2p00.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_medium_jetpt130_eta2p00_2p47.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_tight_jetpt130_eta1p52_2p00.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/dilution/pT_perEta_tight_jetpt130_eta2p00_2p47.pdf}
    }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/rate/eleFR_mediumden_pT_per_Eta_bins_jet130.pdf}
    }
    %\hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/rate/eleFR_mediumden_eta_jet130.pdf}
    }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR/rate/FR_TH2D_FR_mediumden_pT_eta_EWKcorr_130.pdf}
...
\subsection{Fake background validation}
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingLeptonPt.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingLeptonEta.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingLeptonPhi.pdf}
    }
    \hfill
    \subfloat[]{
      \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingLeptonE.pdf}
    }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingJetPt.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingJetEta.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingJetPhi.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/LeadingJetE.pdf}
  }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/VR/fake_VR.pdf}
  }
  %\hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/SRspec/mLepJet_logX}
  }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/CR/Electron.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/CR/MET.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/CR/Jet.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.45\textwidth]{figures/qbh/fakes/CR/ThGrouped.pdf}
  }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_EL_EFF_ID.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_EL_EFF_Iso.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_EL_EFF_Reco.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_EL_EFF_Trigger.pdf}
  }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_TH_PDF.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_TH_AlphaS.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_TH_Scale.pdf}
  }
...
\begin{figure}[h!]
  \captionsetup[subfigure]{labelformat=empty}
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_EL_EFF_Total.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_systs_TH_Total.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_TH2D_systematic_up.pdf}
  }
  \hfill
  \subfloat[]{
    \includegraphics[width=0.5\textwidth]{figures/qbh/fakes/FR_with_systs/FR_TH2D_systematic_down.pdf}
  }
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{figures/qbh/fakes/fakes_systs_SR.png}
...
These sources of uncertainties are eventually considered as two nuisance parameters, fakes statistical uncertainty and fakes systematic uncertainty, in the likelihood function described in Chapter REFER TO FIT.
